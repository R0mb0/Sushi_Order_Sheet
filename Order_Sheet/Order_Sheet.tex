...
\newcommand{\backGroundImage}{\includegraphics[width=\paperwidth,height=\paperheight]{Background.jpg}}
%%%%% 
							...
							\begin{tabularx}{\textwidth}{XXX}
								{
									...
									\begin{adjustwidth}{-1cm}{}
										\begin{itemize}
											\item[] \textbf{Numero tavolo: \rule{8mm}{0.30mm}}
											\item[] \textbf{Numero persone: \rule{8mm}{0.30mm}}
										\end{itemize}
									\end{adjustwidth}
								}&{
									%Restaurant logo
